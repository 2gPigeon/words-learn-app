import type { IrregularVerbItem, SortMode, WordProgress } from '../types'
...
function scoreItem(
  ...
  const due =
    progress?.nextReviewAt !== null && progress?.nextReviewAt !== undefined
...
export function selectIrregularVerbItems(
